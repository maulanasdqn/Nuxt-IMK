<template>
  <aside class="w-64 h-screen" aria-label="Sidebar">
    <div class="overflow-y-auto py-4 px-3 bg-gray-700 h-screen">
      <ul class="space-y-2">
        <li>
          <NuxtLink
            to="/dashboard"
          ...
          >
            ...
            <span class="ml-3 text-white hover:text-gray-800">Dashboard</span>
          </NuxtLink>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span
              class="flex-1 ml-3 text-white whitespace-nowrap hover:text-gray-800"
              >Pricing</span
            >
            <span
